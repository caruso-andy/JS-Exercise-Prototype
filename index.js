...
const carOne = new Car('Civic', 35);
console.log(carOne.toString());
carOne.fill(500);
console.log(carOne.noFuel);
//Think of a way to make odometer equal to total tank level.  If 500 or greater returns "out of fuel at {x} miles";
